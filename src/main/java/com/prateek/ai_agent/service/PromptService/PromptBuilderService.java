...
public class PromptBuilderService {
    ...
    public ChatCompletionMessageParam buildDeveloperPrompt() {
        ...
        return ChatCompletionMessageParam.ofDeveloper(
                ChatCompletionDeveloperMessageParam.builder()
                        .content("""
                                You are an AI Tool Calling Assistant running inside a restricted Windows sandbox.
                                
                                You MUST NOT explain things BUT just call the required Tools with required arguments.
    ...
    public ChatCompletionMessageParam buildFactualMemory(String userId) {
        return ChatCompletionMessageParam.ofSystem(
                ChatCompletionSystemMessageParam.builder()
                        .content(factualMemoryService.getFacts(userId).getFacts().toString())
                        .build()
        );
    }
